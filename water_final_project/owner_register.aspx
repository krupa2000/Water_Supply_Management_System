<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="owner_register.aspx.cs" Inherits="water_final_project.owner_register" %>
...
<body>
    <form id="form1" runat="server">
        <div class="form">
            ...
            <br />
            <button onclick="window.location.href='owner_login.aspx'" type="button" style="height: 31px; width: 278px">Register</button>
            <br />
            <br />
            <a href="owner_login.aspx" style="color: dodgerblue">Already have a membership</a>
        </div>
    </form>
</body>
</html>
